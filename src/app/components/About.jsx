    ...
    return (
        <div id="about" className="about grid min-h-[43vh] ">
            <div className="hero min-h-screen bg-[#050810] mt-[123px]">
                <div className="hero-content my-40 container mx-auto sm:px-9 xl:px-28 md:px-10 lg:px-20 lg:gap-x-7 xl:gap-x-14 2xl:gap-0 2xl:px-4 flex-col lg:flex-row">
                    ...
                    <div className="ml-0 2xl:ml-[180px] text-center sm:text-center md:text-center lg:text-left">
                        <div className="mb-3">
                        <h1 className="text-[25px] sm:text-[32px] lg:text-[32px] xl:text-[32px]  font-poppins-reguler font-bold " data-aos="fade-down-right" data-aos-duration="1000">Hello<FontAwesomeIcon icon={faHand} className="fa-shake fa-sm pb-[13px] text-[#E2C799]" /><span className="text-sd text-[#9400FF] ">I&apos;m Muhammad Rizki</span></h1>

                        </div>
                        <div data-aos="fade-down-right" data-aos-duration="1200">
                            <h1 className="text-[20px] sm:text-[30px] lg:text-[30px] xl:text-[30px] fontcontainer mx-auto  font-poppins-reguler ">A <span className="text-sd text-[#9400FF]">Fullstack Developer</span> 🧑‍💻 Based in <span className="text-sd text-[#9400FF]">indonesia</span>  🌏</h1>
                        </div>
