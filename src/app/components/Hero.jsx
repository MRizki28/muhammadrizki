...
const HeroPage = () => {
    ...
    return (
        <>
            <div className="hero min-h-screen bg-[#030204] ">
                <div className="hero-content md:mb-[153px] mb-[180px] max-w-[90rem] flex-col lg:flex-row 2xl:flex-row-reverse">
                    <div className="avatar justify-center">
                        <div className=" rounded-full lg:w-[80%] md:w-[60%] w-[78%] 2xl:w-[60%] 2xl:ml-[223px]" data-aos="fade-down" data-aos-duration="1000">
                    ...
                    <div>
                        ...
                        <div className="2xl:text-left text-center lg:text-right mt-4 font-poppins-reguler">
            ...
            <div className="arrow-down absolute bottom-4 md:left-[44%] lg:left-[47%] left-[37%] transform -translate-x-1/2 text-white text-3xl animate-bounce">
