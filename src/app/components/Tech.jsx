            ...
            <div className="grid grid-cols-1 md:grid-cols-2 max-w-[90%] container mx-auto md:max-w-[90%] lg:max-w-[77%] xl:max-w-[89%] 2xl:max-w-[77%]">
                <div className="grid grid-cols-2 mb-[63px] md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-3 gap-6 mt-10 container mx-auto items-center lg:mb-[94px] border-b-4 md:border-b-0 md:border-r-4">
                    <div className="bg-transparent justify-center  p-4 flex items-center"  data-aos="fade-up" data-aos-duration="1000">
                        <img src="assets/img/tech/laravel.svg" alt="" className="mr-4 w-[8%] md:w-[20%] aspect-[3/4] object-contai transition-transform transform hover:scale-105 hover:shadow-lg" />
                    ...
                    <div className="bg-transparent justify-center  p-4 flex items-center"  data-aos="fade-down" data-aos-duration="1200">
                        <img src="assets/img/tech/lumen.svg" alt="" className="mr-4 w-[8%] md:w-[20%] aspect-[3/4] object-contai transition-transform transform hover:scale-105 hover:shadow-lg" />
                    ...
                    <div className="bg-transparent justify-center  p-4 flex items-center"  data-aos="fade-up" data-aos-duration="1400">
                        <img src="assets/img/tech/ci.svg" alt="" className="mr-4 w-[8%] md:w-[20%] aspect-[3/4] object-contai transition-transform transform hover:scale-105 hover:shadow-lg" />
                    ...
                    <div className="bg-transparent justify-center  p-4 flex items-center"  data-aos="fade-down" data-aos-duration="1600">
                        <img src="assets/img/tech/react.svg" alt="" className="mr-4 w-[8%] md:w-[20%] aspect-[3/4] object-contai transition-transform transform hover:scale-105 hover:shadow-lg" />
                    ...
                    <div className="bg-transparent justify-center  p-4 flex items-center"  data-aos="fade-up" data-aos-duration="1800">
                        <img src="assets/img/tech/express.png" alt="" className="mr-4 w-[8%] md:w-[20%] aspect-[3/4] object-contai transition-transform transform hover:scale-105 hover:shadow-lg" />
                    ...
                    <div className="bg-transparent justify-center  p-4 flex items-center"  data-aos="fade-down" data-aos-duration="2000">
                        <img src="assets/img/tech/nextjs.png" alt="" className="mr-4 w-[8%] md:w-[20%] aspect-[3/4] object-contai transition-transform transform hover:scale-105 hover:shadow-lg" />
                    ...
                    <div className="bg-transparent justify-center  p-4 flex items-center"  data-aos="fade-up" data-aos-duration="2200">
                        <img src="assets/img/tech/tailwind-css.svg" alt="" className="mr-4 w-[8%] md:w-[20%] aspect-[3/4] object-contai transition-transform transform hover:scale-105 hover:shadow-lg" />
                    ...
                    <div className="bg-transparent justify-center  p-4 flex items-center"  data-aos="fade-down" data-aos-duration="2200">
                        <img src="assets/img/tech/bootstrap.svg" alt="" className="mr-4 w-[8%] md:w-[20%] aspect-[3/4] object-contai transition-transform transform hover:scale-105 hover:shadow-lg" />
                    ...
                    <div className="bg-transparent justify-center  p-4 flex items-center"  data-aos="fade-down" data-aos-duration="1000">
                        <img src="assets/img/tech/php.svg" alt="" className="mr-4 w-[8%] md:w-[20%] aspect-[3/4] object-contai transition-transform transform hover:scale-105 hover:shadow-lg" />
                        <span className="text-xl text-white font-poppins-reguler">PHP</span>
                    </div>
                    <div className="bg-transparent justify-center  p-4 flex items-center"  data-aos="fade-up" data-aos-duration="1000">
                        <img src="assets/img/tech/javascript.svg" alt="" className="mr-4 w-[8%] md:w-[20%] aspect-[3/4] object-contai transition-transform transform hover:scale-105 hover:shadow-lg" />
                    ...
                    <div className="bg-transparent justify-center  p-4 flex items-center"  data-aos="fade-cown" data-aos-duration="1000">
                        <img src="assets/img/tech/restapi.png" alt="" className="mr-4 w-[8%] md:w-[20%] aspect-[3/4] object-contai transition-transform transform hover:scale-105 hover:shadow-lg" />
                        <span className="text-xl text-white font-poppins-reguler">REST API</span>
                    </div>
                    <div className="bg-transparent justify-center  p-4 flex items-center"  data-aos="fade-up" data-aos-duration="1000">
                        <img src="assets/img/tech/mysql.svg" alt="" className="mr-4 w-[8%] md:w-[20%] aspect-[3/4] object-contai transition-transform transform hover:scale-105 hover:shadow-lg" />
